...
const CourseSectionsList = ({ 
  ...
  return (
    <div className={`${isDarkMode ? 'bg-[#1E1E1E]' : 'bg-white'} rounded-lg shadow-md overflow-hidden`}>
      <h2 className={`px-4 py-3 font-bold border-b ${isDarkMode ? 'border-[#333333]' : 'border-gray-200'}`}>
          ...
          >
            ...
            >
              <div className="flex items-center">
                <h3 className="font-medium">{getText(section.title.ar, section.title.en)}</h3>
              </div>
              <div className="flex items-center">
                ...
                {section.lessons.map((lesson) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="font-medium text-sm">{getText(lesson.title.ar, lesson.title.en)}</h4>
                      {lesson.duration && (
